package com.example.lazypizza.features.home.data.utils
        ...
        CategorySection(
            ...
            products = listOf(
                Product(
                    ...
                    "500ml bottle",
                    1.49,
                    "https://example.com/drink_water.png"
                ),
                Product(
                    "d2",
                    ProductCategory.DRINKS,
                    ...
                    1.89,
                    "https://example.com/drink_7up.png"
                ),
                Product(
                    "d3",
                    ProductCategory.DRINKS,
                    ...
                    "Classic cola taste",
                    1.99,
                    "https://example.com/drink_pepsi.png"
                ),
                Product(
                    "d4",
                    ProductCategory.DRINKS,
                    ...
                    2.49,
                    "https://example.com/drink_orangejuice.png"
                ),
                Product(
                    "d5",
                    ProductCategory.DRINKS,
                    ...
                    2.29,
                    "https://example.com/drink_applejuice.png"
                ),
                Product(
                    "d6",
                    ProductCategory.DRINKS,
                    "Iced Tea (Lemon)",
                    "Chilled lemon-flavored tea",
                    2.19,
                    "https://example.com/drink_icedtea.png"
                )
            )
        ),
        CategorySection(
            ...
            products = listOf(
                Product(
                    ...
                    0.59,
                    "https://example.com/sauce_garlic.png"
                ),
                Product(
                    "s2",
                    ProductCategory.SAUCES,
                    "BBQ Sauce",
                    "Sweet smoky barbecue taste",
                    0.59,
                    "https://example.com/sauce_bbq.png"
                ),
                Product(
                    "s3",
                    ProductCategory.SAUCES,
                    "Cheese Sauce",
                    "Rich melted cheese dip",
                    0.89,
                    "https://example.com/sauce_cheese.png"
                ),
                Product(
                    "s4",
                    ProductCategory.SAUCES,
                    "Spicy Chili Sauce",
                    "Hot and tangy chili kick",
                    0.59,
                    "https://example.com/sauce_spicychili.png"
                )
            )
        ),
        CategorySection(
            ...
            products = listOf(
                Product(
                    ...
                    2.49,
                    "https://example.com/icecream_vanilla.png"
                ),
                Product(
                    "i2",
                    ProductCategory.ICE_CREAM,
                    ...
                    2.49,
                    "https://example.com/icecream_chocolate.png"
                ),
                Product(
                    "i3",
                    ProductCategory.ICE_CREAM,
                    ...
                    2.49,
                    "https://example.com/icecream_strawberry.png"
                ),
                Product(
                    "i4",
                    ProductCategory.ICE_CREAM,
                    ...
                    2.79,
                    "https://example.com/icecream_cookies.png"
                ),
                Product(
                    "i5",
                    ProductCategory.ICE_CREAM,
                    "Pistachio Ice Cream",
                    "Nutty and creamy pistachio",
                    2.99,
                    "https://example.com/icecream_pistachio.png"
                ),
                Product(
                    "i6",
                    ProductCategory.ICE_CREAM,
                    "Mango Sorbet",
                    "Refreshing tropical mango",
                    2.69,
                    "https://example.com/icecream_mango.png"
                )
            )
        )
    )
